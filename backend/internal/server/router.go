...
func registerRoutes(
	...
	routes.RegisterPlaygroundRoutes(v1, h, jwtAuth, apiKeyAuth, apiKeyService, opsService, settingService, compositeResolver, cfg)
	routes.RegisterPlaygroundHistoryRoutes(v1, jwtAuth, redisClient)
