export default {
  ...
  version: {
    ...
    updateCheckWarning: 'Unable to verify update status',
    ...
    dockerUpdateDownloaded: 'Update downloaded',
    ...
    restartFailed: 'Restart failed. The downloaded update is still waiting to be applied.',
    retry: 'Retry',
